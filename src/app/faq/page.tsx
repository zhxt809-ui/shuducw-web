...
const faqs = [
  ...
  {
    q: '个体户核定征收和查账征收有什么区别？',
    a: '查账征收按实际账务核算的收入、成本计算应纳税额，要求账簿凭证齐全；核定征收是税务机关在账目不健全、难以准确核算时，按核定收入或成本推算定税。近年来各地对核定征收管理趋严，主要面向账务不健全的小规模主体，且不能把核定征收当作逃税手段——业务规模上来后通常会被要求转查账征收，历史问题还可能被追溯调整。',
  },
  {
    q: '西安直播电商个体户要交哪些税？',
  ...
  {
    q: '西安个体户不记账会有什么后果？',
    a: '根据《个体工商户建账管理暂行办法》，达到建账标准的个体户应当建立账簿，向税务机关报送财务资料。不记账的常见后果：收入成本无法准确核算，征收方式可能被从核定转为查账，历史申报数据被追溯调整；长期账务缺失还容易造成漏报、错报，触发税务风险预警，严重时被认定为异常户并影响个人征信。建议个体户从经营第一年起就规范记账，成本远低于事后补救。',
  },
  {
    q: '西安电商个体户需要开对公账户吗？',
    a: '从合规经营角度强烈建议开。电商个体户如果长期用个人微信、支付宝收取经营款项，属于公私混用，收入难以完整入账，是税务稽查的高频风险点。开立对公账户（或个体工商户专用结算账户）后，平台结算、货款收支均可通过对公渠道走账，账务清晰、申报有据。开户一般需准备营业执照、经营者身份证、经营场所证明等材料，具体以银行要求为准。',
  },
  {
    q: '西安小规模企业季度申报流程是什么？',
    a: '小规模纳税人目前以季度为纳税申报期，流程大致为：1）季度结束后次月（1、4、7、10 月）15 日内办理申报；2）登录电子税务局，进入"我要办税—税费申报"，先确认税种认定（增值税及附加、企业所得税或经营所得等）；3）填报销售额、开具及未开票收入，系统自动计算应缴税款，符合免征条件（月销售额未超过 10 万元的按现行政策免征增值税，具体以最新政策为准）的自动减免；4）核对无误后提交并完成缴款（如涉及）。如无专职会计，建议委托代理记账机构代办，避免错过申报期产生逾期。',
  },
  {
    q: '为什么选择西安数度财务咨询？',
    a: '西安数度财务咨询有限公司 2012 年成立，是首届西安市代理记账协会副会长单位，团队拥有高级会计师、国际注册会计师、注册税务师。深耕西安十余年，提供工商财税托管、财税合规、内部审计、财税风控一站式服务，坚持合规为先、风控为本、落地为王，服务覆盖零售、物流、建筑工程、科技、酒店、老年公寓、管理咨询、商贸、电商、劳务、高新科技、跨境等行业。',
  },
];
