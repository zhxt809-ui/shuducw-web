...
const faqs = [
  ...
  {
    q: '西安主播 / 自媒体收入怎么报税？',
    a: '主播收入的性质取决于经营主体和模式：以个人名义接单、打赏、带货佣金的，多按劳务报酬所得缴纳个税（平台通常代扣代缴）；注册了工作室、个体户或公司的，则按经营所得或企业所得申报。收入达到一定规模后，建议注册个体工商户或公司规范纳税，并保留完整的合同、流水凭证，避免收入性质认定不清带来的补税风险。',
  },
  {
    q: '西安小微企业残保金可以减免吗？',
    a: '可以。按现行政策，在职职工总数 30 人（含）以下的企业暂免征收残疾人就业保障金；安排残疾人就业达到规定比例的，可免缴或按比例减缴。残保金按上年用人单位安排残疾人就业未达到规定比例的差额人数和上年本单位在职职工年平均工资计算缴纳，具体申报口径以当地税务、残联部门最新政策为准。',
  },
  {
    q: '个体户核定征收和查账征收有什么区别？',
    a: '查账征收按实际账务核算的收入、成本计算应纳税额，要求账簿凭证齐全；核定征收是税务机关在账目不健全、难以准确核算时，按核定收入或成本推算定税。近年来各地对核定征收管理趋严，主要面向账务不健全的小规模主体，且不能把核定征收当作"避税工具"——业务规模上来后通常会被要求转查账征收，历史问题还可能被追溯调整。',
  },
  {
    q: '西安直播电商个体户要交哪些税？',
    a: '直播电商个体户通常涉及两项税：增值税（小规模纳税人适用征收率，月销售额未超过 10 万元的按现行政策免征增值税，具体以最新政策为准）和个人所得税（经营所得，适用 5%-35% 超额累进税率）。建议保留平台结算、进货、物流等凭证，按核定的或查账的方式按期申报，避免私户收款隐匿收入。',
  },
  {
    q: '公司收到虚开的发票怎么办？',
    a: '发现取得疑似虚开发票，应立即停止抵扣和入账，作进项税额转出并更正申报，同时留存合同、付款、物流等资料向主管税务机关如实说明。属于善意取得的，配合核查通常可避免或减轻处罚；恶意取得虚开发票的，将面临补税、滞纳金、罚款甚至刑事风险。切勿抱着侥幸心理继续使用。',
  },
  {
    q: '为什么选择西安数度财务咨询？',
